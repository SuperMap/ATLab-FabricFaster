...
func (m *ProposalResponses) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProposalResponses.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("peer/proposal_response.proto", fileDescriptor_2ed51030656d961a)
}
