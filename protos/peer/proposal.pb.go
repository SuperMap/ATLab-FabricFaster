...
func (m *SignedProposals) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignedProposals.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("peer/proposal.proto", fileDescriptor_c4dbb4372a94bd5b)
}
